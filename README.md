...
The following code creates a small server that runs on the PC **(NOT THE ESP32)** and listens on port 5000; speaking the randomly selected words through the speakers. 

Write it using Visual Studio Code (or any other preferred code editor) and save it under a memorable name. To run it, import the file via Bash by using the command, "python filename". 
...
****IMPORTANT:**** Edit the following credentials before deploying:
